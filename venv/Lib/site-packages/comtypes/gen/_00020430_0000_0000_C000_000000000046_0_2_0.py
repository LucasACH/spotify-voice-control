...
__all__ = [ 'FONTSTRIKETHROUGH', 'OLE_YPOS_HIMETRIC',
           'OLE_OPTEXCLUSIVE', 'OLE_YPOS_CONTAINER',
           'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_PIXELS', 'StdFont',
           'OLE_COLOR', 'OLE_XPOS_CONTAINER', 'LoadPictureConstants',
           'IFontEventsDisp', 'Color', 'FONTNAME', 'OLE_TRISTATE',
           'FONTSIZE', 'Checked', 'OLE_YSIZE_HIMETRIC',
           'IPictureDisp', 'FONTITALIC', 'Picture',
           'OLE_XSIZE_CONTAINER', 'FONTBOLD', 'StdPicture',
           'OLE_XSIZE_PIXELS', 'Unchecked', 'FONTUNDERSCORE', 'Gray',
           'VgaColor', 'OLE_XPOS_PIXELS', 'OLE_HANDLE', 'Font',
           'IFontDisp', 'Default', 'OLE_YSIZE_CONTAINER',
           'OLE_YPOS_PIXELS', 'FontEvents', 'OLE_CANCELBOOL',
           'IPicture', 'OLE_XPOS_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL',
           'Monochrome', 'IFont']
